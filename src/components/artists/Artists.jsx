...
function Artists() {
  ...
  const [activeImg, setActiveImg] = useState(img01);
  ...
  return (
    <div ref={mainRef} className="artists__main">
      ...
      <div className="artists__imgWrapper" ref={imageRef}>
        <img src={activeImg} alt="artist" className="artists__img" />
      </div>
...
function ArtistItem({ artist, setActiveImg }) {
  ...
  return (
    ...
    >
      ...
      <a href="/artists" className="artists__listItemLink">

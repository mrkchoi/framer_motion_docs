...
function MeshImage({
  ...
  useFrame(({ clock }) => {
    ...
    if (meshRef.current) {
      ...
      meshRef.current.material.uniforms.uScrollStrengthMultiplier.value =
        scrollStrengthMultiplier;
    ...
    <mesh key={idx} ref={meshRef} rotation={[0, 0, 0]} scale={[1, 1, 1]}>
      ...
      <shaderMaterial
        ...
        vertexShader={
          ...
          uniform float uScrollStrengthMultiplier;
          ...
          void main() {
            ...
            newPosition.z += sin(newPosition.y / uViewportSize.y * PI + PI * 0.5) * uOffset.y * uScrollStrengthMultiplier;
